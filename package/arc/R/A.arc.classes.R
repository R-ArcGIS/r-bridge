...
setClass("arc.object",
    contains = "VIRTUAL",
    representation = list(.ptr = "externalptr", .class = "character"))
...
#' @export
setClass("arc.shape",
    contains = c("list"), representation = list(shapeinfo = "list"))
...
setClass("arc.dataset",
    ...
    representation = list(path = "character", dataset_type = "character"))
...
setClass("arc.table",
    ...
    representation = list(fields = "list"))

##
## base class arc.feature
##
#setClass("arc.feature", contains = c("arc.table", "VIRTUAL"),
#    representation = list(shapeinfo = "arc.shapeinfo", extent = "numeric"))
#' @export
setClass("arc.feature",
    contains = c("arc.table", "VIRTUAL"),
    representation = list(shapeinfo = "list", extent = "numeric"))
